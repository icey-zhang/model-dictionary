...
def generateDataWithDifferentFrequencies_3Channel(Images, r):
    [bs,m1, n1, l1] = np.shape(Images)
    for i in range(l1):
        Images[:, :, i] = (Images[:, :, i] - Images[:, :, i].min()) / (Images[:, :, i].max() - Images[:, :, i].min()) #normalize
    Images_freq_low = []
    Images_freq_high = []
...
###############
#for the vedai dataset
path = '/home/zhangjiaqing/dc/dataset/Houston 2013/'
save_path = '/home/workshop/dataset/VEDAI/images_fre'
DataPath1 = r'/home/zhangjiaqing/dc/dataset/Houston 2013/Houston 2012.mat'
DataPath2 = r'/home/zhangjiaqing/dc/dataset/Houston 2013/LiDAR_MP.mat'
Data1 = loadmat(DataPath1)['HSI']
Data2 = loadmat(DataPath2)['LiDAR']
Data1 =np.expand_dims(Data1,axis=0)
kernel_size = 100
train_image_low, train_image_high = generateDataWithDifferentFrequencies_3Channel(Data1, kernel_size)
savemat("HSI_fre.mat",{"train_image_low":train_image_low.squeeze(0),"train_image_high":train_image_high.squeeze(0)})
